...
}) // тут мы заполняем пустой список фильмов на странице новыми отсортированными данными с нумерацией. Пятое задание более правильный способ
...
//     </li>
//     `
// } // Пятое задание первый способ, который пришёл в голову
